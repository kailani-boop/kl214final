# Automate
### All data is being handled in a script that creates outputs in the clean_data.csv, through a Quarto document from the paper folder. There is an R folder that contains functions and ther are no current script that contain any errors.
...
# Organize
### All raw data found in data folder. Outputs are in a separate folder than data.
...
### Code housed in appropriate folders.
...
# Document
## Great Readme! It has all the descriptive guidlines. The readme even has what functions are found in the script in the R folder.
- [X] **The repo has an effective README** 
 ...
 ### All code is formatted very well and clean with explained comments with the why question in mind versus what. 
